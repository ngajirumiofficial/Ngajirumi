      ...
      <div className="site-header__inner">
        ...
        <nav className="main-nav" aria-label="Navigasi utama">
          <ul className="main-nav__list">
            ...
            <li
              className="main-nav__item main-nav__item--dropdown"
              onMouseEnter={openDropdown}
              onMouseLeave={closeDropdown}
            >
              <button
                className="main-nav__link main-nav__link--dropdown-trigger"
              ...
              >
                Blog
                <svg
                  className={`nav-chevron${blogOpen ? " nav-chevron--open" : ""}`}
                  width="12"
                  height="12"
                  viewBox="0 0 12 12"
                  fill="none"
        ...
        <button
          className={`mobile-nav-toggle ${menuOpen ? "mobile-nav-toggle--active" : ""}`}
          onClick={toggleMenu}
            ...
            <nav className="mobile-menu__nav">
              <ul className="mobile-menu__list">
                ...
                <li className="mobile-menu__item mobile-menu__item--dropdown">
                  <button
                    className="mobile-menu__link mobile-menu__link--trigger"
                  ...
                  >
                    Blog
                    <svg
                      className={`nav-chevron${mobileBlogOpen ? " nav-chevron--open" : ""}`}
                      width="14"
                      height="14"
                      viewBox="0 0 12 12"
                      fill="none"
