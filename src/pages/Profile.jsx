          ...
          <div className="ngaji-rumi-content">
            ...
            <article className="library-card library-card--five">
              ...
              <div className="library-card__content">
                ...
                <p className="library-card__description">
                  Melanjutkan perjalanan belajar Ngaji Rumi dan menemukan
                  makna yang lebih dekat dengan kehidupan.
                </p>
            ...
            <article className="library-card library-card--six">
              ...
              <div className="library-card__content">
                ...
                <p className="library-card__description">
                  Materi Ngaji Rumi 6 sebagai bagian dari perjalanan belajar
            ...
            <article className="library-card library-card--seven">
              ...
              <div className="library-card__content">
                ...
                <p className="library-card__description">
                  Materi Ngaji Rumi 7 sebagai bagian dari perjalanan belajar
                  yang bertahap dan bermakna.
                </p>
            ...
            <article className="library-card library-card--eight">
              ...
              <div className="library-card__content">
                ...
                <p className="library-card__description">
                  Materi Ngaji Rumi 8 sebagai lanjutan perjalanan untuk
                  memahami nilai dan makna dari setiap pembelajaran.
                </p>
            ...
            <article className="library-card library-card--nine">
              ...
              <div className="library-card__content">
                ...
                <p className="library-card__description">
                  Materi Ngaji Rumi 9 sebagai bagian dari rangkaian
            ...
            <article className="library-card library-card--ten">
              ...
              <div className="library-card__content">
                ...
                <p className="library-card__description">
                  Materi Ngaji Rumi 10 sebagai bagian akhir dari rangkaian
                  perjalanan belajar Ngaji Rumi.
                </p>
